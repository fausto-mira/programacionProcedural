...
cursan la materia Algebra Lineal: Nombre, Numero de Registro y Resultado de un parcial (‘A’: Aprobado – ‘R’:
...
void mostrar(FILE *arch)
{
    ...
    else
    {
        ...
        puts("\n\nLista de alumnos Algebra Lineal: \n");
        while (!feof(arch))
        {
